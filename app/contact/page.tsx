    ...
    <main className="min-h-screen bg-white pt-24 overflow-x-hidden">
      ...
      <section className="relative py-20 px-6 bg-gradient-to-br from-blue-50 via-white to-green-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            Lescobags Packaging Solutions - Excellence Delivered
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <motion.button
                      type="submit"
                      className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all text-lg"
            ...
            >
              ...
              <motion.div 
                className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-8 mb-8 shadow-lg hover:shadow-xl transition-shadow duration-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.2 }}
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Tekstilna 40</p>
                      <p className="text-gray-600">16000 Leskovac</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:016640202" className="text-blue-600 hover:text-blue-700">
                        016/640 202
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@lescobags.com" className="text-blue-600 hover:text-blue-700">
                        info@lescobags.com
                      </a>
                    </div>
                  </div>
              ...
              {/* Business Hours */}
              <motion.div 
                className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-8 mb-8 shadow-lg hover:shadow-xl transition-shadow duration-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">10 AM - 3 PM</span>
                  </div>
                  <div className="flex justify-between">
              ...
              {/* Map Placeholder */}
              <motion.div 
                className="aspect-video bg-gradient-to-br from-blue-100 to-green-100 rounded-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow duration-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.4 }}
              ...
              >
                <div className="text-center text-blue-600">
                  ...
                  <p className="text-sm">Leskovac, Serbia</p>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white relative overflow-hidden">
        <motion.div 
          className="absolute top-0 left-0 w-96 h-96 bg-blue-500/20 rounded-full filter blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, 100, 0],
          }}
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-4xl font-bold mb-6">We're Social</h2>
