      ...
      <section className="relative py-32 px-6 bg-gradient-to-br from-blue-50 via-white to-teal-50 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span>Experts in Woven Packaging</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Best-in-the-class Market Value for Global Industries
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-8">
                <motion.div
                  className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 hover:bg-blue-50 transition-colors"
                  whileHover={{ y: -5 }}
                >
                  <h3 className="font-bold text-gray-900 mb-2">4-loop Big Bag</h3>
                  <p className="text-sm text-gray-600">Standard model with four-loop lifting system, adaptable in design and dimensions</p>
                </motion.div>
                <motion.div
                  className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 hover:bg-blue-50 transition-colors"
                  whileHover={{ y: -5 }}
                >
                  <h3 className="font-bold text-gray-900 mb-2">1 or 2-loop Bag</h3>
                  <p className="text-sm text-gray-600">Simple to handle, enables quick filling and transport of multiple bags at once</p>
                </motion.div>
                <motion.div
                  className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 hover:bg-blue-50 transition-colors sm:col-span-2"
                  whileHover={{ y: -5 }}
                >
                  <h3 className="font-bold text-gray-900 mb-2">Quadro Big Bag</h3>
                  <p className="text-sm text-gray-600">Equipped with internal panels (baffles) that maintain shape and stability, optimizing transport and handling</p>
                </motion.div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href="/products/big-bags" className="flex-1">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-6 py-4 bg-gradient-to-r from-blue-700 to-teal-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
                  >
                    View All Types
                  </motion.button>
                </Link>
                <Link href="/contact" className="flex-1">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-6 py-4 bg-white border-2 border-blue-600 text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-300"
                  >
                    Request Quote
                  </motion.button>
                </Link>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link href="/contact" className="flex-1">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-6 py-4 bg-white border-2 border-teal-700 text-teal-700 rounded-xl font-semibold hover:bg-teal-50 transition-all duration-300"
                  >
                    Request Quote
                  </motion.button>
                </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                <span className="bg-gradient-to-r from-slate-700 to-blue-700 bg-clip-text text-transparent">Pillow Bags</span>
              </h2>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link href="/contact" className="flex-1">
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-6 py-4 bg-white border-2 border-slate-700 text-slate-700 rounded-xl font-semibold hover:bg-slate-50 transition-all duration-300"
                  >
                    Request Quote
                  </motion.button>
                </Link>
