  ...
  return (
    <main className="min-h-screen bg-white pt-24 overflow-hidden">
      ...
      <section className="relative py-20 px-6 bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
        <motion.div 
          className="absolute top-10 right-10 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 50, 0],
            y: [0, 30, 0],
          ...
          >
            {images.map((image, index) => (
              ...
              >
                ...
                {/* Hover Overlay */}
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-br from-blue-600 to-purple-600 bg-opacity-0 group-hover:bg-opacity-90 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100"
                  initial={{ opacity: 0 }}
                ...
                <div className="absolute top-4 right-4 z-10">
                  <span className={`px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm ${
                    image.category === 'Production' ? 'bg-blue-500/90 text-white' :
                    image.category === 'Products' ? 'bg-green-500/90 text-white' :
                    image.category === 'Quality' ? 'bg-purple-500/90 text-white' :
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-gray-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div 
              variants={fadeInUp}
              className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer group"
            ...
            >
              <motion.div 
                className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-green-600 transition-colors"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.6 }}
              >
            ...
            >
              <motion.div 
                className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-600 transition-colors"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.6 }}
              >
            ...
            >
              <motion.div 
                className="w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-yellow-600 transition-colors"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.6 }}
              >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <div className="text-xl text-blue-100">Circular Looms</div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <div className="text-xl text-blue-100">m² Facility</div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <div className="text-xl text-blue-100">Quality Tested</div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <div className="text-xl text-blue-100">Production</div>
            </motion.div>
          </motion.div>
        </div>
      </section>
